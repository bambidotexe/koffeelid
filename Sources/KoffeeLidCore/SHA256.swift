...
/// SHA-256 (FIPS 180-4), for the one hash Core has to reproduce: Codex's trust hash of a hook. Foundation
/// has no digest of its own, and Core takes no framework beyond it. `SHA256Tests` holds it to the standard
/// vectors.
public enum SHA256 {

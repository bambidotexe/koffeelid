...
struct SettingsGeneralPage: View {
    ...
    var body: some View {
        SettingsPage {
            ...
            SettingsGroup(title: L("Uninstall"),
                          hint: L("Removes everything KoffeeLid set up outside its own folder: what starts it at login, what lets it hold the Mac awake, what it added to Claude Code, to Codex, to Copilot, to OpenCode and to the shell, and its settings and logs. KoffeeLid then moves itself to the Trash and quits."),
    ...
    private func confirmUninstall() {
        ...
        alert.informativeText = L("KoffeeLid stops holding the Mac awake, gives back the permissions it was granted, removes what starts it at login, what it added to Claude Code, to Codex, to Copilot, to OpenCode and to the shell, and its settings and logs. It then moves itself to the Trash and quits. Removing the sleep lock asks for an administrator password.")

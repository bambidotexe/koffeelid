...
swift test                                            # KoffeeLidCore + LidPlaneKit unit tests (636); needs the Claude Code sandbox off, like xcodebuild
...
- `swift test` is green (636 distinct cases: 614 Core, 22 LidPlaneKit) and the Debug build warning-free at this

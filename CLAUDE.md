...
| the close sound, the volume override | `App/LidCloseSoundPlayer.swift`, `OutputVolumeOverride.swift`; `Core/VolumeOverridePolicy.swift`, `LidSoundRoute.swift`; `App/Resources/Sounds` | `functional.md` § Lid closed, lid open; `macOS.md` § Sounds |

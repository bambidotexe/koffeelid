...
swift test                                            # KoffeeLidCore + LidPlaneKit unit tests (606); needs the Claude Code sandbox off, like xcodebuild
...
- `swift test` is green (606 distinct cases: 584 Core, 22 LidPlaneKit) and the Debug build warning-free at this

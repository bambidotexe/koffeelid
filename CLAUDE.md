...
swift test                                            # KoffeeLidCore + LidPlaneKit unit tests (616); needs the Claude Code sandbox off, like xcodebuild
...
- `swift test` is green (616 distinct cases: 594 Core, 22 LidPlaneKit) and the Debug build warning-free at this

...
| Screen & System Audio Recording | the lid effect | `effect: screen recording not granted; effect stays off`; arming works |
...
App Activity, Screen & System Audio Recording, Input Monitoring, Notifications. The names are quoted from the

...
| What does macOS actually do here (kernel flag, powerd, sleep lock, assertions, lid sensor, modifier keys, displays, capture, TCC, Claude Code's hooks and registry, Codex's hooks and their trust, zsh)? | `macOS.md` |
